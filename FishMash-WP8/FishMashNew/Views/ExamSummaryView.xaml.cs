...
namespace FishMashNew.Views
{
    ...
    /// </summary>
    public sealed partial class ExamSummaryView : Page
    {
        ExamSummaryViewModel viewModel;
        public ExamSummaryView()
        {
            this.InitializeComponent();
            viewModel = new ExamSummaryViewModel(new NavigationService());
