...
namespace FishMashApp.Common
{
    ...
    public class RelayCommand_old : ICommand
    {
        ...
        /// <summary>
        /// Determines whether this <see cref="RelayCommand_old"/> can execute in its current state.
        /// </summary>
        ...
        /// <summary>
        /// Executes the <see cref="RelayCommand_old"/> on the current command target.
        /// </summary>
        /// <param name="parameter">
        /// Data used by the command. If the command does not require data to be passed, this object can be set to null.
        /// </param>
